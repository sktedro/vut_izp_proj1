...
#define maxExecLen 7 //max number of commands by execution - if you wish to try fewer or more args per execution
...
char filename[] = "./main_Uniform"; //needs a space after the name!
